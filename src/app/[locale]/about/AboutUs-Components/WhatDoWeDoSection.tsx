  ...
  return (
    <section className='min-h-screen  flex flex-col  items-center   p-8 pl-9 pr-9 bg-[#fbfbfbd9] '>
        <div className='h-1/2 w-full flex justify-center items-center mt-[4rem]'>
            <div className='w-6/12 flex flex-col  justify-end text-right items-end xl:ml-[10rem] lg:ml-[8rem] xl:block lg:block md:lg:block 2sm:hidden	  '>
                <div className='xl:w-[16rem] xl:h-[23rem] lg:w-[14rem] lg:h-[21rem] md:w-[12rem] md:h-[19rem] 2sm:w-[7rem] 2sm:h-[10rem] relative '>
            ...
            <div className='w-6/12 flex  relative justify-start  items-first ml-[10rem] 2sm:ml-[1rem]'>
        ...
        <h1 className=' xl:text-[3.0rem] lg:text-[2.5rem] md:text-[2.0rem]   font-bold text-primary xl:ml-[35rem] md:ml-[24rem] 2sm:ml-[7rem] 2sm:mb-[4rem]    '>شنو الي احنا نسوية؟</h1>
            ...
            <div className='flex xl:flex-row lg:flex-row md:flex-row 2sm:flex-col justify-center items-center xl:mt-[7.5rem] md:mt-[4.0rem] '>
                <article className={`flex flex-col xl:w-[22rem] xl:h-[17rem] lg:w-[18rem] lg:h-[14rem] md:w-[14rem] md:h-[11rem] 2sm:w-[15rem] 2sm:h-[9rem]  bg-primary items-center relative ml-[2rem] justify-center xl:top-[1rem] md:top-[1rem] lg:top-[1rem] ${styles.tv1}`}>
                    ...
                    <h1 className='text-white xl:text-[1.0rem] lg:text-[0.8rem] md:text-[0.6rem] 2sm:text-[0.5rem] 2sm:w-[12rem] text-center font-bold'>المركز يقدم معدات تنظيف لاصحاب المواكب و توعية بأهمية النظافة, تنظيم حملات التنظيم و استقبال المتطوعين</h1>
                </article>
