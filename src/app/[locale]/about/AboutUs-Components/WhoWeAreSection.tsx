...
const WhoWeAreSection = () => {
  return (
    <section id='whoweare' className='min-h-screen  flex flex-col items-center  p-8 pl-9 pr-9 bg-white '>
     ...
     <div className='mr-[4rem]'>
        ...
        <article className='flex flex-col  text-right lg:w-3/5	 overflow-hidden ml-[2rem] lg:ml-[10rem] md:mt-[5rem] 2sm:mt-[5rem]'>
            <h1 className='lg:text-[2.0rem] md:text-[2.2rem] sm:text-[1.8rem] md:text-center sm:text-center   font-bold text-primary 2sm:text-center 2sm:text-[1.2rem]'>منو سفراء النظافة</h1>
            ...
            <div className='flex mt-[2rem] justify-center '>
                <div className='flex flex-col xl:mr-[5rem] lg:mr-[5rem] md:mr-[2rem] 2sm:mr-[2rem] '>
                    ...
                    <h1 className='text-primary text-center lg:text-[0.8rem] 2sm:text-[0.5rem] font-bold '>نساهم بتنظيف  <br /> الاماكن العامه</h1>
                </div>
                <div className='flex flex-col mr-[1rem] 2sm:mr-[2rem] '>
                    ...
                    <h1 className='text-primary text-center lg:text-[0.8rem]  2sm:text-[0.5rem] font-bold'>ما اشمر النفايات ابدا</h1>
                </div>
                <div className='flex flex-col '>
                    <Image src={plastic} alt='plastic' className='lg:h-[5rem] lg:w-[5rem] 2sm:h-[3rem] 2sm:w-[3rem]' />
                    <h1 className='text-primary w-full text-center lg:text-[0.8rem] 2sm:text-[0.5rem] font-bold'>توعية الناس <br /> الي يذبون الزبالة</h1>
                </div>
            </div>
            ...
            <h1 className='font-bold mt-[1.2rem] lg:text-[2.2rem] text-secondary 2sm:text-[1.3rem] '>وخلال فترة قصيرة</h1>
